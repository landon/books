...
\tikzstyle{labeledStyle}=[shape = circle, minimum size = 6pt, inner sep = 5pt, outer sep = 5pt, draw]
\tikzstyle{unlabeledStyle}=[shape = circle, minimum size = 6pt, inner sep = 5pt, outer sep = 5pt, draw, fill]
\tikzstyle{532f9ccb-bc7b-4b29-b41b-c7fac8d640b0}=[shape = circle,minimum size = 6pt,inner sep = 5pt,outer sep = 5pt,draw,fill = red]
\tikzstyle{e6d9f5fc-90ba-4576-bad8-6b53a35507e9}=[shape = circle,minimum size = 6pt,inner sep = 5pt,outer sep = 5pt,draw,fill=blue]
\Vertex[style = unlabeledStyle, x = 0.800, y = 0.850, L = \small {}]{v0}
\Vertex[style = labeledStyle, x = 0.550, y = 0.700, L = \small {$x_1$}]{v1}
\Vertex[style = unlabeledStyle, x = 1.050, y = 0.700, L = \small {}]{v2}
\Vertex[style = labeledStyle, x = 0.950, y = 0.400, L = \small {$x_2$}]{v3}
\Vertex[style = unlabeledStyle, x = 0.650, y = 0.400, L = \small {}]{v4}
\Vertex[style = 532f9ccb-bc7b-4b29-b41b-c7fac8d640b0, x = 0.550, y = 1.000, L = \small {$y_1$}]{v5}
\Vertex[style = e6d9f5fc-90ba-4576-bad8-6b53a35507e9, x = 0.950, y = 0.150, L = \small {$y_2$}]{v6}
\Edge[label = \tiny {}, labelstyle={auto=right, fill=none}](v1)(v0)
\Edge[label = \tiny {}, labelstyle={auto=right, fill=none}](v1)(v4)
\Edge[label = \tiny {}, labelstyle={auto=right, fill=none}](v2)(v0)
\Edge[label = \tiny {}, labelstyle={auto=right, fill=none}](v3)(v2)
...
But this is not the only possible generalization of acylic that works, late we will see another based on counting certain substructures of the oriented graph. 
